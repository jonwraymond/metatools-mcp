...
func maybeCreateExecutor(execCfg config.ExecutionConfig, idx index.Index, docs tooldoc.Store, runner run.Runner) (code.Executor, error) {
	...
	return code.NewDefaultExecutor(code.Config{
		...
		MaxChainSteps:  execCfg.MaxChainSteps,
	})
}
